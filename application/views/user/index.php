<main>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.1s">Ut enim ad minim veniam, quis nostrud
                                    exercitation ullamco laboris nisi uquip ex ea commodo consequat is aute irure.</p>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img ">
                        <div class="about-font-img d-none d-lg-block">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/about2.png" alt="">
                        </div>
                        <div class="about-back-img ">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/about1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center no-gutters">
                            ...
                            <div class="col-lg-5">
                                <div class="dept_thumb">
                                    <img src="<?= base_url('assets/user/') ?>assets/img/gallery/department_man.png"
                                        alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="single-testimonial text-center">
                    ...
                    <div class="testimonial-caption ">
                        <div class="testimonial-top-cap">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/testimonial.png" alt="">
                        ...
                        <div class="testimonial-founder d-flex align-items-center justify-content-center">
                            <div class="founder-img">
                                <img src="<?= base_url('assets/user/') ?>assets/img/gallery/Homepage_testi.png" alt="">
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/team2.png" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/team3.png" alt="">
                        </div>
                        <div class="team-caption">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/team1.png" alt="">
                        </div>
                        <div class="team-caption">
    ...
    <div class="contact-form-main">
        ...
        <div class="from-left d-none d-lg-block">
            <img src="<?= base_url('assets/user/') ?>assets/img/gallery/contact_form.png" alt="">
        </div>
    </div>
    <!-- Contact form End -->
